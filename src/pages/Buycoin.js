...
// import { buyPlan } from "../api/plans"

// // Stripe
// import { loadStripe } from "@stripe/stripe-js"
// import { Elements, CardElement, useElements, useStripe } from "@stripe/react-stripe-js"

// // IMPORTANT: replace with your publishable key in runtime (do NOT hardcode secret keys)
// // You can also set this via localStorage.setItem("stripe_pk", "pk_test_...")
// // const getStripePk = () => (typeof window !== "undefined" && localStorage.getItem("stripe_pk")) || "pk_test_51S0xo5PbJYWCjUgkbBipbYBsiu1jiY0KpwGYXyGVKQzfhe9dzVmoqPA3EPcnLpH4czevC6wtXDfurAB7Tl9Q7LSE00mbeqIGPx"
...
//       </p>
//       <p style={{ marginTop: -8 }}>
//         Price: <code>{planId || "N/A"}</code>
//       </p>
//       <button type="submit" className="btn btn-success w-100" disabled={loading || !planId}>
...
//   const stripePromise = useMemo(() => loadStripe("pk_test_51S0xo5PbJYWCjUgkbBipbYBsiu1jiY0KpwGYXyGVKQzfhe9dzVmoqPA3EPcnLpH4czevC6wtXDfurAB7Tl9Q7LSE00mbeqIGPx"), [])
...
//                           planId={planId}
//                           onPurchased={() => {
//                             // no-op for now, could navigate to dashboard
//                           }}
//                         />
