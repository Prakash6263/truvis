...
//         <button className="theme-btn mb-3 w-100 btn btn-primary me-2">
//           + New Chat
//         </button>
//         <a>
...
//             This section provides a high-level summary of the system being
//             assessed...
//           </div>
//           {/* Add System Details */}
...
//           <div className="section-title mb-3 text-dark">
//             Upload System Documentation
//           </div>
//           <div className="mb-3">
//             <label className="btn btn-outline-secondary theme-btn">
//               Browse Files <input type="file" style={{ display: "none" }} />
//             </label>
//           </div>
...
//             System_Architecture_v7.0.pdf &nbsp; • &nbsp; 2.5 MB &nbsp; • &nbsp;
//             PDF
//           </div>
//           {/* Submit Buttons */}
//           <div className="text-center mt-5">
//             <div>
//               <button className="btn btn-outline-secondary btn-nav me-2">
//                 Cancel
//               </button>
//               <button className="btn btn-success btn-nav">Submit</button>
//             </div>
//           </div>
//         </div>
//       </div>
...
const RiskManagement = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const assessmentId = res?.id || res?.data?.data?._id || res?.data?._id || res?.data?.id || res?.assessmentId
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="file-name text-dark">
                  {files.length > 0 && (
                    <>
                      <i className="fas fa-file-pdf me-2 text-danger" />
                      {files[0].name} &nbsp; • &nbsp; {files[0].size / 1024} KB &nbsp; • &nbsp;
