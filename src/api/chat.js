// // src/api/chat.js
// // central place for all chat-related API requests
...
// // ----------------------
// // 🟢 Stream text-only message
// // ----------------------
// // usage: streamMessage(chatId, "hello", onToken, onDone, onError)
// export function streamMessage(chatId, content, onToken, onDone, onError) {
...
// // ----------------------
// // 🟢 Upload file + message (with streaming)
// // ----------------------
// // usage: uploadMessageStream(chatId, "check this file", file, onToken, onDone, onError)
// export function uploadMessageStream(chatId, content, file, onToken, onDone, onError) {
